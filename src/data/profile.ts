export const profile = {
  ...
  emails: {
    primary: "davidbcmos@gmail.com",
    secondary: "dblancas@myuax.com",
  },
...
export const education = [
  {
    title: "Software Development | Multiplatform Application Development (DAM)",
    institution: "Universidad Alfonso X el Sabio (UAX)",
    period: "10/2024 – present",
    location: "Madrid, Spain",
    description:
      "Focus on backend and data technologies; Java, Python, SQL, Spring Boot, Android, databases, software engineering.",
  },
  {
    title: "Big Data & Artificial Intelligence | Professional Specialization",
    institution: "Universidad Alfonso X el Sabio (UAX)",
    period: "10/2024 – present",
    location: "Madrid, Spain",
    description:
      "Big Data architectures, CRISP-DM, ML/DL, NLP, CV, GenAI; Python stack and AWS services (S3, Glue, Athena, Redshift, EMR, Kinesis, Lambda, Firehose).",
  },
];
